...
def send_transaction(addr_from, private_key, addr_to, amount):
    ...
    """
    print("sent from " + addr_from + "to " + private_key + "amount: " + addr_to, amount)
...
def check_transactions():
    ...
    """
    try:
        res = requests.get('http://localhost:3000/blocks')
...
def generate_ECDSA_keys():
    ...
    print(F"Your new address and private key are now in the file {filepath}")
